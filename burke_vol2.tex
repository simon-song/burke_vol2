...
\makepagestyle{ocd}
\makeevenhead{ocd}{\thepage}{Works of Edmund Burke: Vol. II}{}  
...
%% from https://tex.stackexchange.com/questions/258394/make-block-of-text-italicized
...
\begin{center}
  ...
  \HUGE{THE WORKS} \par \vspace{0.2in}
  \HUGE{OF} \par \vspace{0.2in}
  \HUGE{EDMUND BURKE} \par \vspace{1.5in}
  \LARGE{Volume II}  \par \vspace{0.2in}
\end{center}
